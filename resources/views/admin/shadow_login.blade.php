...
<body class="min-h-screen flex items-center justify-center p-4 md:p-6 overflow-hidden">
    ...
    <div
        class="fixed top-[-80px] left-[-80px] w-[260px] h-[260px] md:w-[420px] md:h-[420px] rounded-full floating-blur-1">
    </div>
    <div
        class="fixed bottom-[-100px] right-[-100px] w-[300px] h-[300px] md:w-[460px] md:h-[460px] rounded-full floating-blur-2">
    </div>

    <div
        class="w-full max-w-7xl min-h-[88vh] max-h-[920px] bg-white rounded-[32px] overflow-hidden shadow-2xl relative z-10 grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr]">
        <!-- LEFT SIDE -->
        <div
            class="relative hidden lg:flex flex-col justify-between p-12 xl:p-16 bg-gradient-to-br from-[#f8fffb] via-[#eef8f2] to-[#ffffff]">
            ...
            <div class="relative z-10">
                <div
                    class="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-[#005f37]/8 border border-[#005f37]/10 text-[#005f37] font-semibold text-sm">
                    <div class="w-2.5 h-2.5 rounded-full bg-[#005f37]"></div>
                    Portal Manajemen Logistik
                </div>
            </div>
            ...
            <div class="relative z-10 max-w-xl">
                <h1 class="text-4xl xl:text-5xl font-extrabold text-slate-900 leading-tight mb-6">
                    Membangun Fondasi
                    <span class="text-[#005f37]">Bangsa</span>
                </h1>
                <p class="text-slate-600 text-lg leading-relaxed max-w-lg">
                    Kelola distribusi material batu split dan operasional quarry <b>PT Conbloc Indotama</b> dengan
                    efisien. Presisi data adalah kunci ketahanan infrastruktur.
                </p>

                <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="bg-white/80 border border-[#005f37]/10 rounded-2xl p-5 shadow-sm">
                        <p class="text-[#005f37] font-bold text-lg">Kontrol Stok</p>
                        <p class="text-slate-500 text-sm mt-1">Pantau volume produksi batu split dan agregat secara
                            real-time.</p>
                    </div>
                    <div class="bg-white/80 border border-[#005f37]/10 rounded-2xl p-5 shadow-sm">
                        <p class="text-[#005f37] font-bold text-lg">Keamanan Data</p>
                        <p class="text-slate-500 text-sm mt-1">Sistem akses terenkripsi untuk integritas data
                            operasional batu.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="flex items-center justify-center p-6 sm:p-10 lg:p-12 bg-white">
            <div class="w-full max-w-[460px] soft-card rounded-[20px] p-8 sm:p-10">
